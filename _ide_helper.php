...
namespace {
    ...
    class Fractal extends \Spatie\Fractal\FractalFacade{
        ...
        public static function create($data = null, $transformer = null, $serializer = null){
            return \Spatie\Fractalistic\Fractal::create($data, $transformer, $serializer);
        }
        ...
        public static function collection($data, $transformer = null, $resourceName = null){
            return \Spatie\Fractalistic\Fractal::collection($data, $transformer, $resourceName);
        }
        ...
        public static function item($data, $transformer = null, $resourceName = null){
            return \Spatie\Fractalistic\Fractal::item($data, $transformer, $resourceName);
        }
        ...
        public static function data($dataType, $data, $transformer = null){
            return \Spatie\Fractalistic\Fractal::data($dataType, $data, $transformer);
        }
        ...
        public static function transformWith($transformer){
            return \Spatie\Fractalistic\Fractal::transformWith($transformer);
        }
        ...
        public static function serializeWith($serializer){
            return \Spatie\Fractalistic\Fractal::serializeWith($serializer);
        }
        ...
        public static function paginateWith($paginator){
            return \Spatie\Fractalistic\Fractal::paginateWith($paginator);
        }
        ...
        public static function withCursor($cursor){
            return \Spatie\Fractalistic\Fractal::withCursor($cursor);
        }
        ...
        public static function parseIncludes($includes){
            return \Spatie\Fractalistic\Fractal::parseIncludes($includes);
        }
        ...
        public static function parseExcludes($excludes){
            return \Spatie\Fractalistic\Fractal::parseExcludes($excludes);
        }
        ...
        public static function addMeta(){
            return \Spatie\Fractalistic\Fractal::addMeta();
        }
        ...
        public static function withResourceName($resourceName){
            return \Spatie\Fractalistic\Fractal::withResourceName($resourceName);
        }
        ...
        public static function toJson(){
            return \Spatie\Fractalistic\Fractal::toJson();
        }
         ...
         */
        public static function toArray(){
            return \Spatie\Fractalistic\Fractal::toArray();
        }
        ...
        public static function createData(){
            return \Spatie\Fractalistic\Fractal::createData();
        }
        ...
        public static function getResource(){
            return \Spatie\Fractalistic\Fractal::getResource();
        }
        ...
        public static function jsonSerialize(){
            return \Spatie\Fractalistic\Fractal::jsonSerialize();
        }
