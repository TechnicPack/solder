module.exports = {
     ...
     */
    post(uri, form) {
        return Platform.sendForm('post', uri, form);
    },
     ...
     */
    put(uri, form) {
        return Platform.sendForm('put', uri, form);
    },
     ...
     */
    patch(uri, form) {
        return Platform.sendForm('patch', uri, form);
    },
     ...
     */
    delete(uri, form) {
        return Platform.sendForm('delete', uri, form);
    },
